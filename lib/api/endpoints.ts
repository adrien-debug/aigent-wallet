...
export const API_ROUTE_CATALOG = [
  {
    method: "GET" as const,
    path: "/api/v1",
    description: "Discovery — liste des routes",
  },
  {
    method: "GET" as const,
    path: "/api/v1/openapi",
    description: "Contrat OpenAPI 3 (JSON)",
  },
  {
    method: "GET" as const,
    path: "/api/v1/metrics",
    description: "KPIs + séries graphiques",
  },
  {
    method: "GET" as const,
    path: "/api/v1/wallets",
    description: "Liste wallets (seed + mémoire)",
  },
  {
    method: "POST" as const,
    path: "/api/v1/wallets",
    description: "Créer un wallet (mémoire)",
  },
  ...
  },
  {
    ...
    description: "Liste policies (seed + mémoire)",
  },
  {
    method: "POST" as const,
    path: "/api/v1/policies",
    description: "Créer une policy (mémoire)",
  },
  {
    method: "GET" as const,
    path: "/api/v1/policies/:id",
    description: "Détail policy",
  },
  ...
  { method: "GET" as const, path: "/api/v1/pricing", description: "Plans (mock)" },
  {
    method: "GET" as const,
    path: "/api/health",
    description: "Sonde liveness (sans auth)",
  },
] as const;
